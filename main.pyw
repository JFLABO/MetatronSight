...
def cell_was_clicked( row, column):
    ...
    #メッセージはJSONでやり取りしようよ
    #アジャイルな感じでデータを受け取るWebAPIをRails6で用意
    #バックエンドはスキーマレスなMongodbとつないでみたよ　AzureSQL
    #いろいろ追加したくなったり予期せぬデータが飛んでくる昨今
    #8割検証済み　たぶんうまくいく　カスタム可能プログラム　5月5日リリース☆彡
    #シナリオ/////////////////////////////////////////////////////////////////
...
def setjson():
    ...
    for item in data:
        ...
        Data2 = QTableWidgetItem(str(item["oid"]))
        j = 1
